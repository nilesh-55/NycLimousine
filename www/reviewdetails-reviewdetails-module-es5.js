...
var ReviewdetailsPageModule = /** @class */ (function () {
    function ReviewdetailsPageModule() {
    }
    ...
    return ReviewdetailsPageModule;
}());
...
var ReviewdetailsPage = /** @class */ (function () {
    function ReviewdetailsPage(router, envservice, _FB, modalController, loadingController, toastCtrl) {
        this.router = router;
    ...
    ReviewdetailsPage.prototype.ngOnInit = function () {
    ...
    ReviewdetailsPage.prototype.presentModal = function () {
    ...
    ReviewdetailsPage.prototype.toggleGroup = function (group) {
        console.log(group);
    ...
    ;
    ReviewdetailsPage.prototype.isGroupShown = function (group) {
        return this.shownGroup === group;
    };
    ReviewdetailsPage.prototype.nextButton = function () {
        var _this = this;
        if (this.serviceName == "Round Trip") {
            this.roundtrip();
        }
            ...
            this.presentLoading().then(function (a) {
                _this.data.Userid = _this.user_id;
                _this.data.clsSelectVehicelDetails = _this.carData;
                _this.data.clsSelectVehicelDetails.clsPaymentDetail = _this.formvalues;
                _this.data.vehicleId = _this.carData.VehicleId;
                _this.data.clsSelectVehicelDetails.clsVehicleFinalRates.NewInclusivealltax = _this.final_Price;
                if (localStorage.getItem('amenityData')) {
                    var amenities_data = localStorage.getItem('amenityData');
                    _this.amenities_fare = JSON.parse(amenities_data);
                    console.log(_this.amenities_fare);
                    _this.data.clsSelectVehicelDetails.clsVehicleAmenityDetails = _this.amenities_fare;
                }
                ...
                if (_this.serviceName == "One way") {
                    _this.data.clsSelectVehicelDetails.clsVehicleFinalRates.NewhsubTotal = _this.carData.clsVehicleFinalRates.Rate;
                    _this.data.clsSelectVehicelDetails.clsVehicleFinalRates.NewSalestax = _this.Sales_tax_Span;
                    _this.data.clsSelectVehicelDetails.clsVehicleFinalRates.Newhtotalfare = _this.carData.clsVehicleFinalRates.Total_Fare;
                    _this.data.clsSelectVehicelDetails.clsVehicleFinalRates.NewTolls = _this.carData.clsVehicleFinalRates.Tolls;
                    _this.data.clsSelectVehicelDetails.clsVehicleFinalRates.NewAirport_Parking = _this.carData.clsVehicleFinalRates.Airport_Parking;
                }
                if (_this.serviceName == "Hourly") {
                    if (localStorage.getItem('numberofHours')) {
                        var newHourly = localStorage.getItem('numberofHours');
                        _this.newhourlyrate = newHourly;
                        console.log(_this.newhourlyrate);
                        _this.data.clsSelectVehicelDetails.clsVehicleFinalRates.NewHNoMinHour = _this.newhourlyrate;
                    }
                    else {
                        _this.data.clsSelectVehicelDetails.clsVehicleFinalRates.NewHNoMinHour = _this.data.clsSelectVehicelDetails.clsVehicleFinalRates.Hourly_min_hours;
                    }
                    if (localStorage.getItem('subtotal')) {
                        var subTotal = localStorage.getItem('subtotal');
                        _this.newSubtotal = subTotal;
                        console.log(_this.newSubtotal);
                        _this.data.clsSelectVehicelDetails.clsVehicleFinalRates.NewhsubTotal = _this.newSubtotal;
                    }
                    else {
                ...
                if (localStorage.getItem('extracharges')) {
                    ...
                    _this.extraCharge = JSON.parse(extraCharge);
                    _this.data.clsSelectVehicelDetails.clsVehicleExtraCharges = _this.extraCharge;
                }
                console.log(_this.data);
                _this.envservice.getConfirmation(_this.data)
                    .then(function (data) {
                    console.log(data.data);
                    _this.response = JSON.parse(data.data);
                    localStorage.setItem("final_confirmation", JSON.stringify(_this.response));
    ...
    ReviewdetailsPage.prototype.roundtrip = function () {
        var _this = this;
        this.presentLoading().then(function (a) {
            _this.data.Userid = _this.user_id;
            _this.data.clsSelectVehicelDetails = _this.carData;
            ...
            _this.data.clsSelectReturnVehicelDetails = _this.carData2;
            _this.data.clsSelectReturnVehicelDetails.clsPaymentDetail = _this.formvalues2;
            _this.data.PickupSelectedVehicle = _this.carData2.VehicleId;
            _this.data.clsSelectReturnVehicelDetails.clsVehicleFinalRates.NewInclusivealltax = _this.final_Price2;
            _this.envservice.getReturnConfirmation(_this.data).subscribe(function (data) {
                console.log(data);
    ...
    ReviewdetailsPage.prototype.presentToast = function () {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            var toast;
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
    ...
    ReviewdetailsPage.prototype.presentLoading = function () {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            var loading;
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
    ...
    ReviewdetailsPage.prototype.serviceAgreementModal = function () {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            var modal;
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
...
//# sourceMappingURL=reviewdetails-reviewdetails-module-es5.js.map