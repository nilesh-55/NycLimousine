...
let MytripsPage = class MytripsPage {
    constructor(envservice, appcomp, loadingController, modalController) {
    ...
    tripList() {
        ...
        this.presentLoading().then(a => {
            ...
            this.envservice.getTripList(this.formData).then((data) => {
                ...
                let monthYear = moment__WEBPACK_IMPORTED_MODULE_3__(date).add(0, 'year').format('MMM YYYY');
                let datttt = moment__WEBPACK_IMPORTED_MODULE_3__(date).format('DD');
                let day = moment__WEBPACK_IMPORTED_MODULE_3__(date).format('dddd');
