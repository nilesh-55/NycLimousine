...
let AddPassengerPage = class AddPassengerPage {
    constructor(envservice, loadingController, modalController, toastCtrl) {
    ...
    addPassenger() {
        ...
        this.presentLoading().then(a => {
            ...
            this.envservice.addPassengers(this.formData).then((data) => {
...
AddPassengerPage.ctorParameters = () => [
...
let AddProjectPage = class AddProjectPage {
    constructor(loadingController, envservice, _FB, modalController, toastCtrl) {
        this.loadingController = loadingController;
        this.envservice = envservice;
        this._FB = _FB;
        this.modalController = modalController;
    ...
    addProject() {
        ...
        this.presentLoading().then(a => {
            ...
            this.envservice.addProjects(this.formData.ProjectId, this.formData.ProjectName, this.formData.projectdescription, this.formData.fk_user_ccinfoid, this.formData.useriD, this.formData.username).then((data) => {
                this.response = JSON.parse(data.data);
                console.log(this.response);
                this.presentToast(this.response.Data);
                this.loadingController.dismiss();
...
const routes = [
    ...
    {
        path: 'home',
        loadChildren: () => Promise.all(/*! import() | home-home-module */[__webpack_require__.e("default~filldetails-filldetails-module~home-home-module~mytrips-mytrips-module~reviewdetails-reviewd~c2799781"), __webpack_require__.e("home-home-module")]).then(__webpack_require__.bind(null, /*! ./home/home.module */ "./src/app/home/home.module.ts")).then(m => m.HomePageModule)
    },
    {
        path: 'list',
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, router, modalController, loginPanel, alertController, loadingController) {
...
let FarecalculationsPage = class FarecalculationsPage {
...
FarecalculationsPage.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] }
];
...
let FarecalculationsreturnPage = class FarecalculationsreturnPage {
    constructor(modalController) {
        this.modalController = modalController;
    }
    ngOnInit() {
...
FarecalculationsreturnPage.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] }
];
...
let FeedbackModalPage = class FeedbackModalPage {
    constructor(envservice, loadingController, modalController, _FB) {
        this.envservice = envservice;
        this.loadingController = loadingController;
        this.modalController = modalController;
        this._FB = _FB;
    ...
    feedback() {
        this.presentLoading().then(a => {
            ...
            this.envservice.feedbackPost(this.name, this.email, this.cellphone, this.message).subscribe((data) => {
                console.log(data);
...
let LegalpagePage = class LegalpagePage {
    constructor(loadingController, envservice, modalController) {
        this.loadingController = loadingController;
        this.envservice = envservice;
        this.modalController = modalController;
    }
...
let LoginPage = class LoginPage {
    constructor(_FB, envservice, loadingController, router, alertController, route, googlePlus) {
        this._FB = _FB;
        this.envservice = envservice;
        this.loadingController = loadingController;
        this.router = router;
    ...
    onLogin() {
        this.presentLoading().then(a => {
            ...
            this.envservice.login(this.formData).then((data) => {
                this.response = JSON.parse(data.data);
                ...
                buttons: [
                    {
                        ...
                        handler: (value) => {
                            this.presentLoading().then(a => {
                                this.envservice.sendotp(value.name1).subscribe((data) => {
                                    console.log(data);
                                    if (data.Message == 'success') {
...
let ModalpagePage = class ModalpagePage {
    constructor(envservice, modalController, loadingController) {
        this.envservice = envservice;
        this.modalController = modalController;
        this.loadingController = loadingController;
    }
...
let ModelfromComponent = class ModelfromComponent {
    constructor(modalController, envservice) {
        this.modalController = modalController;
        this.envservice = envservice;
...
ModelfromComponent.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] },
    { type: _services_env_service__WEBPACK_IMPORTED_MODULE_3__["EnvService"] }
];
...
let ModeltoComponent = ModeltoComponent_1 = class ModeltoComponent {
    constructor(modalController, envservice) {
        this.modalController = modalController;
        this.envservice = envservice;
...
ModeltoComponent.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] },
    { type: _services_env_service__WEBPACK_IMPORTED_MODULE_2__["EnvService"] }
];
...
let PaymentModalPage = class PaymentModalPage {
    constructor(modalController, envservice, _FB, loadingController) {
        this.modalController = modalController;
        this.envservice = envservice;
        this._FB = _FB;
        this.loadingController = loadingController;
    ...
    addCardDetails() {
        this.presentLoading().then(a => {
            ...
            this.envservice.savePaymentInfo(this.formData.CCInfoId, this.formData.CardNumber, this.formData.CCCardType, this.formData.CVVNumber, this.formData.CCExpiryMonth, this.formData.CCExpiryYear, this.formData.CardHolderName, this.formData.BillingAddress1, this.formData.BillingAddress2, this.formData.BillingCity, this.formData.BillingState, this.formData.BillingZip, this.formData.BillingCountry, this.formData.FromScreen, this.formData.username, this.formData.userid).subscribe((data) => {
                if (data.Message == 'success') {
                    alert(data.Data);
                    this.dismissModal();
                }
...
let PrivacyModalPage = class PrivacyModalPage {
    constructor(modalController, loadingController, envservice) {
        this.modalController = modalController;
        this.loadingController = loadingController;
        this.envservice = envservice;
    }
    ngOnInit() {
        this.presentLoading().then(a => {
            this.envservice.privacyStatement().subscribe((data) => {
                console.log(data.Data);
...
PrivacyModalPage.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["LoadingController"] },
    { type: _services_env_service__WEBPACK_IMPORTED_MODULE_3__["EnvService"] }
];
...
let EnvService = class EnvService {
    ...
    savePaymentInfo(value1, value2, value3, value4, value5, value6, value7, value8, value9, value10, value11, value12, value13, value14, value15, value16) {
...
let StopsLocationPage = class StopsLocationPage {
    constructor(modalController, envservice) {
        this.modalController = modalController;
        this.envservice = envservice;
        this.isItemAvailable = false;
...
StopsLocationPage.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] },
    { type: _services_env_service__WEBPACK_IMPORTED_MODULE_3__["EnvService"] }
];
...
let TripDatesPage = class TripDatesPage {
    constructor(modalController) {
        this.modalController = modalController;
    }
    ngOnInit() {
