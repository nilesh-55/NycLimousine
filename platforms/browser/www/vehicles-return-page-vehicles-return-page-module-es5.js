...
var VehiclesReturnPagePageModule = /** @class */ (function () {
    function VehiclesReturnPagePageModule() {
    }
    ...
    return VehiclesReturnPagePageModule;
}());
...
var VehiclesReturnPagePage = /** @class */ (function () {
    function VehiclesReturnPagePage(router, activatedRoute, envservice, toastCtrl) {
        this.router = router;
    ...
    VehiclesReturnPagePage.prototype.user = function (user) {
        throw new Error("Method not implemented.");
    };
    VehiclesReturnPagePage.prototype.ionViewWillEnter = function () {
        localStorage.removeItem("amenityData2");
    };
    VehiclesReturnPagePage.prototype.ngOnInit = function () {
        this.roundtrip = this.data.TypeOfServiceName;
    };
    VehiclesReturnPagePage.prototype.viewDetail = function (item) {
        console.log(item);
        localStorage.setItem('car_detail2', JSON.stringify(item));
        this.router.navigate(['/select-returnvehicle']);
    };
    VehiclesReturnPagePage.prototype.presentToast = function () {
    ...
    VehiclesReturnPagePage.ctorParameters = function () { return [
...
//# sourceMappingURL=vehicles-return-page-vehicles-return-page-module-es5.js.map