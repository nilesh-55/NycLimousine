...
var ThankyouPage = /** @class */ (function () {
    function ThankyouPage(platform, router, callNumber, modalController) {
        this.platform = platform;
        this.router = router;
        this.callNumber = callNumber;
        this.modalController = modalController;
        var fullname = "123456789000";
        var names = fullname.split("9", -3);
    ...
    ThankyouPage.prototype.homepage = function () {
    ...
    ThankyouPage.prototype.toCall = function () {
    ...
    // }
    ThankyouPage.prototype.writeTous = function () {
