...
var SelectvehiclePageModule = /** @class */ (function () {
    function SelectvehiclePageModule() {
    }
    ...
    return SelectvehiclePageModule;
}());
...
var SelectvehiclePage = /** @class */ (function () {
    function SelectvehiclePage(activatedRoute, envservice, modalController, router, loadingController) {
    ...
    SelectvehiclePage.prototype.ngOnInit = function () {
        var a = this.amenitiesDetails.length;
        // this.amenitiesDetails.splice(a-1);
    };
    SelectvehiclePage.prototype.ionViewWillEnter = function () {
        //  const amount = localStorage.getItem("final_rate");
        //  this.finalAmount = JSON.parse(amount);
        localStorage.removeItem("car_detail2");
    };
    SelectvehiclePage.prototype.getAmenityCalculations = function (e, amid, price) {
        console.log(price);
        console.log(e.detail.value.Value, amid);
        this.amenitiesDetails = this.carData.clsVehicleAmenityDetails;
        var check = this.amenitiesDetails.findIndex(function (x) { return x.FK_AmenityID == amid; });
        console.log(check);
        if (check != -1) {
    ...
    SelectvehiclePage.prototype.stateChange = function (ev) {
        // this.amenitiesDetails = this.carData.clsVehicleAmenityDetails;
        this.theSate1 = ev.detail.checked;
        console.log(this.theSate1);
        if (this.theSate1 == true) {
            var check = this.amenitiesDetails.findIndex(function (x) { return x.FK_AmenityID == 6; });
            console.log(check);
            if (check != -1) {
    ...
    SelectvehiclePage.prototype.presentModal = function () {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss()
                            ...
                            var val = data.data;
                            console.log(val);
                            _this.finalAmount = val;
                            localStorage.setItem("final_rate", JSON.stringify(_this.finalAmount));
                        });
    ...
    SelectvehiclePage.prototype.presentLoading = function () {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            var loading;
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
    ...
    SelectvehiclePage.prototype.goToPayment = function () {
        var _this = this;
        this.presentLoading().then(function (a) {
            if (_this.data.TypeOfServiceName == 'Round Trip') {
                _this.router.navigate(['/vehicles-return-page']);
            }
            else if (_this.data.TypeOfServiceName == 'Hourly') {
                _this.router.navigate(['/filldetails']);
            }
            else if (_this.data.TypeOfServiceName == 'One way') {
                _this.router.navigate(['/filldetails']);
            }
            else if (_this.data.TypeOfServiceName == 'Wait and Return') {
                _this.router.navigate(['/filldetails']);
            }
            _this.loadingController.dismiss().then(function () { return console.log('dismissed'); });
        });
    };
    SelectvehiclePage.ctorParameters = function () { return [
...
//# sourceMappingURL=selectvehicle-selectvehicle-module-es5.js.map