...
var UserprofilePage = /** @class */ (function () {
    function UserprofilePage(envservice, _FB, loadingController, appcomp) {
        ...
        var value = localStorage.getItem('loginData');
    ...
    UserprofilePage.prototype.updateProfile = function () {
        ...
        this.presentLoading().then(function (a) {
            _this.telephone = _this.form.get('telephone').value;
            _this.envservice.updateProfile(_this.firstname, _this.lastname, _this.telephone, _this.email, _this.email).subscribe(function (data) {
    ...
    UserprofilePage.prototype.presentLoading = function () {
