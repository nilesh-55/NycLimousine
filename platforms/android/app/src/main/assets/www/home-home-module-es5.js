...
var HomePage = /** @class */ (function () {
    function HomePage(_FB, router, envservice, modalController, toastCtrl, loadingController, platform, appcomp) {
        this._FB = _FB;
        this.router = router;
    ...
    HomePage.prototype.serviceList = function () {
        var _this = this;
        this.envservice.getServiceList()
            .subscribe(function (data) {
            _this.noOfService = data.Data;
        });
    };
    HomePage.prototype.hourlyType = function () {
        var _this = this;
        this.envservice.getHourlyType()
            .subscribe(function (data) {
            _this.noOfHours = data.Data;
        });
    };
    HomePage.prototype.getHours = function (value) {
        console.log(value.detail.value);
        localStorage.setItem("noofHours", value.detail.value);
    };
    HomePage.prototype.waitTime = function () {
        var _this = this;
        this.envservice.getWaitingTime()
            .subscribe(function (data) {
            _this.waitingTime = data.Data;
        });
    };
    HomePage.prototype.stopFields = function () {
    ...
    HomePage.prototype.addNewInputField = function () {
        var control = this.form1.controls.objLiclsResStops;
        control.push(this.stopFields());
        console.log(control.value);
    };
    HomePage.prototype.removeInputField = function (i) {
        var control = this.form1.controls.objLiclsResStops;
        control.removeAt(i);
    };
    HomePage.prototype.stopModal = function (i) {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss()
                            .then(function (data) {
                            var val = data.data;
                            var control = _this.form1.controls.objLiclsResStops;
    ...
    HomePage.prototype.radioChecked = function (e) {
        // this.form1.controls['screenType'].setValue(e);
    };
    HomePage.prototype.presentmodal1 = function () {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss()
                            .then(function (data) {
                            var val = data.data;
                            _this.locationType = data.data.Location_Type;
                            _this.locationName = data.data.Location_Name;
                            if (_this.locationName == '') {
                                _this.form1.controls['FromLocationName'].setValue(val.Location_Address);
                                localStorage.setItem("fromLocation", val.Location_Address);
                            }
                            else if (_this.locationType == 'A') {
                                _this.form1.controls['FromLocationName'].setValue(val.Location_Name);
                                localStorage.setItem("fromLocation", val.Location_Name);
                            }
                            else {
                                _this.form1.controls['FromLocationName'].setValue(val.Location_Name + val.Location_Address);
                                localStorage.setItem("fromLocation", val.Location_Name);
                            }
                        });
                        return [4 /*yield*/, modal.present()];
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss()
                            ...
                            _this.locationType = data.data.Location_Type;
                            if (_this.locationName == '') {
                                _this.form1.controls['ToLocationName'].setValue(val.Location_Address);
                                localStorage.setItem("toLocation", val.Location_Address);
                            }
                            else if (_this.locationType == 'A') {
                                _this.form1.controls['ToLocationName'].setValue(val.Location_Name);
                                localStorage.setItem("toLocation", val.Location_Name);
                            }
                            else {
                                _this.form1.controls['ToLocationName'].setValue(val.Location_Name + val.Location_Address);
                                localStorage.setItem("toLocation", val.Location_Name);
                            }
                        });
                        return [4 /*yield*/, modal.present()];
    ...
    HomePage.prototype.changeDate = function () {
        var date = this.form1.get('PickUpDate').value;
        var monthYear = moment__WEBPACK_IMPORTED_MODULE_8__(date).add(0, 'year').format('MMM YYYY');
        var datttt = moment__WEBPACK_IMPORTED_MODULE_8__(date).format('DD');
        var day = moment__WEBPACK_IMPORTED_MODULE_8__(date).format('dddd');
        var old = moment__WEBPACK_IMPORTED_MODULE_8__(date).format('DD/MM/YYYY');
        var curr_time = moment__WEBPACK_IMPORTED_MODULE_8__(date).format('hh:mm');
        this.selectMonthYear = monthYear;
        this.selectDay = datttt;
        this.selectDate = day;
        this.dateShow = false;
    };
    HomePage.prototype.addMinutes = function (times, minsToAdd) {
    ...
    //// Time section
    HomePage.prototype.changeTime = function () {
        var time = this.form1.get('PickupTime24H').value;
        var full = moment__WEBPACK_IMPORTED_MODULE_8__(time).format('H:mm');
        var half = moment__WEBPACK_IMPORTED_MODULE_8__(time).format('hh:mm A');
        this.fulltime = full;
        this.halftime = half;
        this.timeShow = false;
    };
    HomePage.prototype.timeicon = function () {
        this.timeShow = true;
        this.form1.controls['PickupTime24H'].setValue('');
    };
    HomePage.prototype.dateicon = function () {
        this.dateShow = true;
        this.form1.controls['PickUpDate'].setValue('');
    };
    HomePage.prototype.changeRoundtripDate = function () {
        var date = this.form1.get('ReturnDate').value;
        var monthYear1 = moment__WEBPACK_IMPORTED_MODULE_8__(date).add(0, 'year').format('MMM YYYY');
        var datttt1 = moment__WEBPACK_IMPORTED_MODULE_8__(date).format('DD');
        var day1 = moment__WEBPACK_IMPORTED_MODULE_8__(date).format('dddd');
        var old = moment__WEBPACK_IMPORTED_MODULE_8__(date).format('DD/MM/YYYY');
        var curr_time = moment__WEBPACK_IMPORTED_MODULE_8__(date).format('hh:mm');
    ...
    HomePage.prototype.changetRoundtripTime = function () {
        var time = this.form1.get('ReturnTime24H').value;
        var full1 = moment__WEBPACK_IMPORTED_MODULE_8__(time).format('H:mm');
        var half1 = moment__WEBPACK_IMPORTED_MODULE_8__(time).format('hh:mm A');
        this.fullRoundtriptime = full1;
        this.halfRoundtriptime = half1;
        this.timeShow1 = false;
    };
    HomePage.prototype.timeRoundtripicon = function () {
        this.timeShow1 = true;
        this.form1.controls['ReturnTime24H'].setValue('');
    };
    HomePage.prototype.dateRoundtripicon = function () {
        this.dateShow1 = true;
        this.form1.controls['ReturnDate'].setValue('');
    };
    HomePage.prototype.doReorder = function (ev) {
        ...
        var control = this.form1.controls.objLiclsResStops;
        var newIndex = this.oldid + this.newid;
        if (newIndex === -1) {
        ...
        var currentGroup = control.at(this.oldid);
        control.removeAt(this.oldid);
        control.insert(newIndex, currentGroup);
        console.log(control.controls);
    };
    HomePage.prototype.toggleReorderGroup = function () {
    ...
    HomePage.prototype.onSubmit = function () {
        var date = this.form1.get('PickUpDate').value;
        var selectedDate = moment__WEBPACK_IMPORTED_MODULE_8__(date).format('DD/MM/YYYY');
        var selectedMonth = moment__WEBPACK_IMPORTED_MODULE_8__(date).format('MM');
        var selectedonlyDate = moment__WEBPACK_IMPORTED_MODULE_8__(date).format('DD');
        var returndate = this.form1.get('ReturnDate').value;
        var selectedReturnDate = moment__WEBPACK_IMPORTED_MODULE_8__(returndate).format('DD/MM/YYYY');
        var selectedReturnMonth = moment__WEBPACK_IMPORTED_MODULE_8__(returndate).format('MM');
        var selectedonlyReturnDate = moment__WEBPACK_IMPORTED_MODULE_8__(returndate).format('DD');
        var time = this.form1.get('PickupTime24H').value;
        var selctedTime = moment__WEBPACK_IMPORTED_MODULE_8__(time).format('H:mm');
        var returntime = this.form1.get('ReturnTime24H').value;
        var selectedReturnTime = moment__WEBPACK_IMPORTED_MODULE_8__(returntime).format('H:mm');
        var timeNow = new Date().getTime();
        var oneHourIntoFuture = new Date(timeNow + 1000 * 60 * 60 * 1);
        var time24 = moment__WEBPACK_IMPORTED_MODULE_8__(oneHourIntoFuture).format('H:mm');
        var currentDate = moment__WEBPACK_IMPORTED_MODULE_8__(timeNow).format('DD/MM/YYYY');
    ...
    HomePage.prototype.afterValidations = function () {
        var _this = this;
    ...
    HomePage.prototype.vehiclesList = function () {
        var _this = this;
        ...
        this.envservice.submitAllData(this.form1.value)
            ...
            var resMsg = _this.response.Message;
            if (resMsg === "success") {
                var resData = _this.response.Data;
            ...
            _this.message = _this.errorResponse.Message;
            _this.presentToast();
            _this.loadingController.dismiss();
        });
